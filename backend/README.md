...
## Project Structure
    ...
    ├── tstdanieldjart_dev_22880  # Django project configurations
...
1. Clone this repo and `cd tstdanieldjart_dev_22880`
...
2. Clone this repo and `cd tstdanieldjart_dev_22880`
